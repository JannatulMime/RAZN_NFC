...
//  
//    let bgColor : Color = Color.black//Color(hex: "#292929")!
//   
//    var body: some View {
//        
//        
    ...
    var body: some View {
        ...
        Image("BG")
            ...
            .overlay(
                LinearGradient(
                    gradient: Gradient(stops: [
                        .init(color: bgColor.opacity(0.2), location: 0.0), // Dark at very top
                       // .init(color: bgColor.opacity(0.0), location: 0.2), // Quickly fade to transparent
                       // .init(color: bgColor.opacity(0.0), location: 0.8), // Stay transparent for most of the middle
                      //  .init(color: bgColor.opacity(0.0), location: 0.8), // Quickly fade to
                        .init(color:bgColor.opacity(1.0), location: 1.0), // Dark again at bottom
                    ]),
                    startPoint: .top,
